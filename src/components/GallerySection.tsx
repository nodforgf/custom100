...
function PhotoCard({ photoUrl, idx, style, photoDate }: PhotoCardProps) {
  ...
  const messages = [
    "เค้าชอบมากเลยเวลาได้อยู่กับเธอ 🫶",
    "เค้ากลัวผีแต่เค้าก็ดูหนังเป็นเพื่อนเธอได้ ☺️",
    "ไม่อยากให้ตากฝนนะ กลัวเธอไม่สบาย 🥺",
    "เค้าชอบโทรคุยกับแฟน เพราะเค้าชอบฟังเสียงแฟน 🫶",
    "แฟนกินได้ตะมุตะมิมาก แต่น่าร๊ากสุดๆไปเลย 🐶",
    "อันนี้แถมๆเพราะแฟนดูกวนประสาทดี555 😋",
  ];
