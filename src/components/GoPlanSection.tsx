...
const WISHES = [
  { id: 1,  text: "อยากนอนกอดแฟน 🫣",                color: "#ffd6e7" },
  { id: 2,  text: "อยากไปเที่ยวทะเลกับเธอ 🌊🏖️", color: "#fce4ec" },
  { id: 3,  text: "อยากอยู่ด้วยทุกวัน 🏡",        color: "#fff0f8" },
  { id: 4,  text: "อยากพาแฟนไปหาอารายกินอร่อยๆ 🍱",           color: "#ffd6e7" },
  { id: 5,  text: "อยากจุ๊บแฟน 😘",          color: "#fce4ec" },
