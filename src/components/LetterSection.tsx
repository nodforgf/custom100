                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>Happy anniversary 1month 🫶🤍
สุขสันต์วันครบรอบนะแฟนเค้าดีใจนะที่มีเธอเข้ามาในชีวิตเค้าเธอทำให้ชีวิตเค้ามีความสุขมากๆเลยเค้าชอบเวลาอยู่กับแฟนมากตอนนั่งมองแบบหื้ยทำไมคุณแฟนน่าร๊ากจังแฟนใครสวยจางอยู่แบบนี้เลย
แบบชอบมากๆเค้าชอบทุกอย่างที่เป็นแฟนแฟนไม่ต้องคิดมากเลยนะเค้าไม่ได้เอาแฟนมาแทนที่ใครและเค้าตั้งใจรักแฟนมาตั้งแต่แรกอยู่แล้วนะก็ไม่มี
อารายมากก็ขอให้อยู่ด้วยกันทุกวันทุกเทศกาลและทุกปีนะเธอเค้ารักเธอนะรักมากๆเลยละผ่านมาถึง1เดือนละนะก็ช่วยอยู่กับเค้าแบบนี้ไปนานๆนะค้าบ</p>
                                    </div>
